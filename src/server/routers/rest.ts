    ...
    this.router.post(
      ...
      async (req: ExpressRequest, res: ExpressResponse) => {
        try {
          ...
          logger.info({ searchTerm, targetLanguage }, "Researching topic with AI");
          ...
          const researchResult = await researchService.researchTopic(searchTerm, targetLanguage);
    ...
    this.router.post(
      ...
      async (req: ExpressRequest, res: ExpressResponse) => {
        try {
          ...
          logger.info({ title, targetLanguage }, "Generating scenes with AI");
          ...
          const scenesResult = await researchService.generateScenes(content, title, targetLanguage);
