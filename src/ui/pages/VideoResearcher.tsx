...
interface ResearchResult {
  ...
  content: string;
  sources: string[];
  suggestedScenes: SceneInput[];
  suggestedConfig: RenderConfig;
  language: string;
}
...
const VideoResearcher: React.FC = () => {
  ...
  const getAvailableVoices = (): VoiceEnum[] => {
    if (!editableConfig.ttsEngine) return [];
    return voicesForEngine[editableConfig.ttsEngine] || [];
  };
              ...
              <Grid container spacing={3}>
                <Grid item xs={12} sm={6}>
                  <FormControl fullWidth>
                    ...
                    <Select
                      value={editableConfig.ttsEngine || TTSEngineEnum.edgetts}
